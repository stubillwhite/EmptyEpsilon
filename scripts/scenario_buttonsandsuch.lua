...
--ee HATES the below but it's needed to have fucking drones
player:setDockClasses("Drone")
player:setDocks(2, 1, 1, 1, 1, 1)
player:addDrones("L3 Mouse", 1)
player:addDrones("L3 Cat", 1)
player:addDrones("H9 Owl", 1)
player:addDrones("M19 Rino", 1)
player:addDrones("L3 Rabbit", 1)
...
--Planets--
 ...
 --Artifacts, Buoys, Jammers, etc--
	...
	MagAttack1 = CpuShip():setTemplate("Ship_Test_Larp"):setFaction("Independent"):setPosition(-16556, -39333):orderIdle()
    MagAttack2 = CpuShip():setTemplate("Ship_Test_Larp"):setFaction("Independent"):setPosition(-222, -40000):orderIdle()
    MagAttack3 = CpuShip():setTemplate("Ship_Test_Larp"):setFaction("Independent"):setPosition(-16444, -53000):orderIdle()
    MagAttack4 = CpuShip():setTemplate("Ship_Test_Larp"):setFaction("Independent"):setPosition(-444, -53556):orderIdle()
...
if autoruns == 0 then
	autohail(MagWarn1, 3000, "Oops! You shouldn't be here. Turn around and we'll forget all about it.", "Forewarned about consequences of entering Magrathean space", "Magenta", "Comms", 0)
	end
if autoruns == 1 then
	autohail(MagWarn2, 3000, "We have warned you. You don't get many warnings, darling.", "Given a chance to leave unharmed.", "Magenta", "Comms", 1)
	end
if autoruns == 2 then
	autohail(MagWarn3, 3000, "Okay, we'll be firing super friendly missiles at you now.", "Decided to enter missile zone of own free will.", "Magenta", "Comms", 2)
	end
	
autofire(MagAttack1, 3000, player, "automated defence systems triggered", "Magenta", "Comms")
autofire(MagAttack2, 3000, player, "automated defence systems triggered", "Magenta", "Comms")
autofire(MagAttack3, 3000, player, "automated defence systems triggered", "Magenta", "Comms")
autofire(MagAttack4, 3000, player, "automated defence systems triggered", "Magenta", "Comms")
