...
-- SBW
template = ShipTemplate():setName("Skirmish Frigate"):setClass("Frigate", "Skirmish"):setModel("SpaceshipEscapePodRed"):setRecorded(false)
...
template:setWarpSpeed(1000)
template:setSpeed(100, 14, 25) -- SBW
