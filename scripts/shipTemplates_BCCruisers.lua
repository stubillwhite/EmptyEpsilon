...
--UCN
template = ShipTemplate():setName("UCS Sword Cruiser"):setClass("Cruiser", "Sword"):setModel("HeliconCorpNorasClassCruiserBlue")
...
template = ShipTemplate():setName("UCS Colony Battlecruiser"):setClass("Cruiser", "Colony"):setModel("HeliconCorpChroneClassBattlecruiserBlue")
