...
-- For the target analysis screen
for type=1,10 do
...
ModelData():setName("planets/2k_jupiter.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("2k_jupiter.jpg")
ModelData():setName("planets/2k_mars.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("2k_mars.jpg")
ModelData():setName("planets/2k_mercury.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("2k_mercury.jpg")
ModelData():setName("planets/2k_neptune.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("2k_neptune.jpg")
ModelData():setName("planets/2k_uranus.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("2k_uranus.jpg")
ModelData():setName("planets/2k_venus_atmosphere.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("2k_venus_atmosphere.jpg")
ModelData():setName("planets/4k_ceres_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("4k_ceres_fictional.jpg")
ModelData():setName("planets/4k_eris_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("4k_eris_fictional.jpg")
ModelData():setName("planets/4k_haumea_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("4k_haumea_fictional.jpg")
ModelData():setName("planets/4k_makemake_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("4k_makemake_fictional.jpg")
ModelData():setName("planets/8k_saturn.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("8k_saturn.jpg")
ModelData():setName("planets/8k_saturn_ring_alpha.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("8k_saturn_ring_alpha.png")
ModelData():setName("planets/ceres_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("ceres_fictional.jpg")
ModelData():setName("planets/crateres-1.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("crateres-1.png")
ModelData():setName("planets/earth2.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("earth2.jpg")
ModelData():setName("planets/earth3.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("earth3.jpg")
ModelData():setName("planets/eris_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("eris_fictional.jpg")
ModelData():setName("planets/foret.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("foret.jpg")
ModelData():setName("planets/gas-1.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("gas-1.png")
ModelData():setName("planets/haumea_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("haumea_fictional.jpg")
ModelData():setName("planets/lava-1.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("lava-1.jpg")
ModelData():setName("planets/makemake_fictional.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("makemake_fictional.jpg")
ModelData():setName("planets/moon-1.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("moon-1.png")
ModelData():setName("planets/planet-1.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("planet-1.png")
ModelData():setName("planets/planet-2.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("planet-2.png")
ModelData():setName("planets/star-1.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("star-1.png")
ModelData():setName("planets/strange-1.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("strange-1.jpg")
ModelData():setName("planets/strange-2.jpg"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("strange-2.jpg")
ModelData():setName("planets/superearth.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("superearth.png")
ModelData():setName("planets/superjupiter.png"):setScale(30):setRadius(50):setMesh("sphere.obj"):setTexture("superjupiter.png")
...
-- Add for LARP Version
model = ModelData()
model:setName("Lisse mobile shipyard")
model:setMesh("Lisse mobile shipyard/Lisse mobile shipyard.obj")
model:setTexture("Lisse mobile shipyard/Lisse mobile shipyard-texture.jpg")
model:setSpecular("Lisse mobile shipyard/Lisse mobile shipyard-texture.jpg")
model:setIllumination("Lisse mobile shipyard/Lisse mobile shipyard-texture.jpg")
model:setScale(80)
model:setRadius(5000)
model:setCollisionBox(10000, 5000)
--model:setRenderRotation(0, 0, -90)

model = ModelData()
model:setName("station_tore")
model:setMesh("Tore/Tore-dim.model")
model:setTexture("Tore/ToreTexture.jpg")
-- if heavy model
-- model:setRenderOffset(0, 0, -180)
-- model:setRenderRotation(10, 0, 0)
-- model:setScale(150)
-- model:setRadius(20000)
-- if small model
model:setRenderOffset(0, 0, -5)
--model:setRenderRotation(10, 0, 0)
model:setScale(5000)
...
model = ModelData()
model:setName("station_commerce")
model:setMesh("Commerce Station/Commercestation-FINAL.model")
model:setTexture("Commerce Station/CommercestationTexture.jpg")
model:setIllumination("Commerce Station/Commercestation-Illumination.jpg")
model:setRenderOffset(0, 0, 0.5)
model:setScale(1000)
model:setRadius(2500)

model = ModelData()
model:setName("station_asteroid")
model:setMesh("Station Asteroid/Station_Asteroid.model")
model:setTexture("Station Asteroid/Station_Asteroid_RenderMap.jpg")
model:setIllumination("Station Asteroid/Station_Asteroid_RenderMap.jpg")
model:setRenderOffset(90, 25, 0)
model:setScale(20)
model:setRadius(2500)

model = ModelData()
model:setName("station_babylon")
model:setMesh("Babylon Station/BabylonStation.model")
model:setTexture("Babylon Station/Station_GCG_Babylon_Lightmap.jpg")
model:setIllumination("Babylon Station/Station_GCG_Babylon_Lightmap.jpg")
model:setRenderOffset(0, 0, 5)
model:setScale(20)
model:setRadius(2500)
