--[[                  Alien ship templates
These are older ship templates, going to be replaced soon.
----------------------------------------------------------]]


----------------------Ktlitan ships
template = ShipTemplate():setName("Alien Fighter"):setModel("sci_fi_alien_ship_1")
...
template = ShipTemplate():setName("Alien Breaker"):setModel("sci_fi_alien_ship_2")
...
template = ShipTemplate():setName("Alien Worker"):setModel("sci_fi_alien_ship_3")
...
template = ShipTemplate():setName("Alien Drone"):setModel("sci_fi_alien_ship_4")
template:setRadarTrace("radar_ktlitan_drone.png")
template:setBeam(0, 40, 0, 600.0, 4.0, 6)
template:setHull(30)
template:setSpeed(120, 10, 25)

template = ShipTemplate():setName("Alien Feeder"):setModel("sci_fi_alien_ship_5")
...
template = ShipTemplate():setName("Alien Scout"):setModel("sci_fi_alien_ship_6")
template:setRadarTrace("radar_ktlitan_scout.png")
template:setBeam(0, 40, 0, 600.0, 4.0, 6)
template:setHull(100)
template:setSpeed(150, 30, 25)

template = ShipTemplate():setName("Alien Destroyer"):setModel("sci_fi_alien_ship_7")
...
template = ShipTemplate():setName("Alien Queen"):setModel("sci_fi_alien_ship_8")
