...
function init()
    ...
    starfighter1 = PlayerSpaceship():setTemplate("Interceptor")
        :setPosition(0, 0):setRotationMaxSpeed(14.8)
        :setWarpDrive(true):setWarpSpeed(1000, 1000)
        :setCallSign("interceptor")
        :commandImpulse(100)

    -- starfighter12 = PlayerSpaceship():setTemplate("Interceptor")
    --     :setPosition(1000, 0):setRotationMaxSpeed(14.8)
    --     :setWarpDrive(true):setWarpSpeed(1000, 1000)
    --     :setCallSign("interceptor")
    --     :commandImpulse(100)

    -- starfighter13 = PlayerSpaceship():setTemplate("Interceptor")
    --     :setPosition(2000, 0):setRotationMaxSpeed(14.8)
    --     :setWarpDrive(true):setWarpSpeed(1000, 1000)
    --     :setCallSign("interceptor")
    --     :commandImpulse(100)
