...
: click_and_drag_state(CD_None)
{
    ...
    personality_selector->addEntry(tr("", "Normal"), "Normal");
    personality_selector->addEntry(tr("", "Pacifist"), "Pacifist");
    personality_selector->addEntry(tr("", "Hostile"), "Hostile");
    personality_selector->addEntry(tr("", "Solo"), "Solo");
