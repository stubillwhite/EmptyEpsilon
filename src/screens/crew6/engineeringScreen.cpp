...
void EngineeringScreen::applyPreset(int preset)
{
    for(int n = 0; n < SYS_COUNT; n++)
    {
        ...
        my_spaceship->commandSetSystemPowerRequest(system, my_spaceship->power_presets[n][preset]);
        my_spaceship->commandSetSystemCoolantRequest(system, my_spaceship->coolant_presets[n][preset]);
    }
}
